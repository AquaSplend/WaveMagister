...
<c:forEach items="${offers.freight}" var="offer" varStatus="status">
        ...
        <form>
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input value=${offer.freight[status.index]} type="number" class="input form-control dailyFreight" id="resFreight" title="Daily freight" disabled>
                </div>
